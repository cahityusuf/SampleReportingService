...
{
    public class DisconnectedRepository<TEntity> : BaseRepository<TEntity>, IRepository<TEntity> where TEntity : class
    {
        public DisconnectedRepository(IUnitOfWork dbContext) : base(dbContext)
        {
        }
